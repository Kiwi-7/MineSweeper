...
public class GameFrame extends JFrame implements ActionListener{
    ...
    MineTile[][] board = new MineTile[0][0];
    ...
    GameFrame(int row, int col,int mines){    
        ...
        beginerLv = new JMenuItem("Beginer");
        expertLv = new JMenuItem("Expert");
        
        beginerLv.addActionListener(this);
        expertLv.addActionListener(this);
        
        difficulty.add(beginerLv);
        ...
        textLabel.setText("Mine: " + Integer.toString(mineCount));
